...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        names = 'class', title = f'Total Success Launches for {entered_site}')
        return fig2
# TASK 4:
...
def get_scatter_chart(entered_site, payload_slider):
    ...
    if entered_site == 'ALL':
        ...
        filtered_df = spacex_df[spacex_df['Launch Site'] == entered_site]
        fig2 = px.scatter(filtered_df[mask], x = 'Payload Mass (kg)', 
        y = 'class', title = f'Correlation between Payload and Success for {entered_site}',
        color="Booster Version Category")
        return fig2
# Run the app
